! function(t) {
    ...
    a.simplex2 = function(t, o) {
        ...
        var n, a, e, i, h, v, l, w, M, c, p = (t + o + r) * u,
            ...
            A = o - x + q,
            b = r - m + q;
        z >= A ? A >= b ? (h = 1, v = 0, l = 0, w = 1, M = 1, c = 0) : z >= b ? (h = 1, v = 0, l = 0, w = 1, M = 0, c = 1) : (h = 0, v = 0, l = 1, w = 1, M = 0, c = 1) : A < b ? (h = 0, v = 0, l = 1, w = 0, M = 1, c = 1) : z < b ? (h = 0, v = 1, l = 0, w = 0, M = 1, c = 1) : (h = 0, v = 1, l = 0, w = 1, M = 1, c = 0);
        var g = z - h + s,
            j = A - v + s,
            k = b - l + s,
            B = z - w + 2 * s,
        ...
        var P = .6 - E * E - F * F - G * G;
        return P < 0 ? i = 0 : (P *= P, i = P * P * K.dot3(E, F, G)), 32 * (n + a + e + i)
